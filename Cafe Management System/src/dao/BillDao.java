...
public class BillDao {
    ...
    public static void save(Bill bill){
        String query = "insert into bill values('"+bill.getId()+"','"+bill.getName()+"','"+bill.getMobileNumber()+"','"+bill.getEmail()+"','"+bill.getDate()+"','"+bill.getTotal()+"','"+bill.getCreadtedBy()+"')";
    ...
    public static ArrayList<Bill> getAllRecordsByInc(String date){
        ...
        try{
            ...
            while(rs.next()){
                ...
                bill.setCreadtedBy(rs.getString("createdBy"));
                arrayList.add(bill);
            }
        }
        catch(Exception e){
